#! apl
      ...
      ⍝ ------------------------------------------------------------------------
      ⍝ 1. Write a function for calculating sum of all numbers in a matrix:
      ...
      ⍝ ------------------------------------------------------------------------
      ⍝ 2. Improve implemented sum function to be able to handle array of any
      ⍝ rank:

      ⍝ Modified reduction. Because possible rank is less or equal to 15
      Sum ← { +/+/+/+/+/+/+/+/+/+/+/+/+/+/+/⍵ }
      ⍝ Sum←{(+/⍴⍵)≤1:⍵ ⋄ ∇ +/⍵} used in the Dyalog workspace
      ...
      ⍝ ------------------------------------------------------------------------
      ⍝ Write a function to find all occurrence indices of a given character in
      a string:
